...
class _ProfileTabState extends State<ProfileTab> with SingleTickerProviderStateMixin {
  ...
  Future<void> loadCurrentUser() async {
    ...
    final user = await FirestoreCloudService.getuser(currentUser.uid);

    // حماية الـ State من التحديث بعد خروج الشاشة لتجنب تسريب الذاكرة
    if (!mounted) return;
                  ...
                  tabs: [
                    Tab(
                      icon: SvgPicture.asset(
                        ...
                        width: 24,
                        height: 24,
                        colorFilter: const ColorFilter.mode(Color(0xFFF6BD00), BlendMode.srcIn),
                      ),
                      text: "Watch List",
                    ),
                    Tab(
